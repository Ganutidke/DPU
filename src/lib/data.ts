...
export interface Event {
  ...
  export const events: Event[] = [
    ...
    { id: '2', title: 'AI in Modern Business Seminar', date: 'November 2, 2024', description: 'Explore how artificial intelligence is shaping the future of business, from marketing to operations. We will discuss case studies from leading companies and ethical considerations.', type: 'Seminar', academicYear: '2024-2025', year: 'Junior', images: ['https://placehold.co/800x600.png'], links: [{title: 'Reading List', url: '#'}] },
    { id: '3', title: 'Fall Fest Social', date: 'November 9, 2024', description: 'Join us for a campus-wide social with games, music, and food. A great way to de-stress before finals and meet new people from different departments.', type: 'Social', academicYear: '2024-2025', year: 'All', images: ['https://placehold.co/800x600.png'] },
    { id: '4', title: 'Intramural Basketball Tournament', date: 'November 15, 2024', description: 'Compete in our annual 3v3 basketball tournament. Sign up your team of 3-5 players. All skill levels are welcome!', type: 'Sports', academicYear: '2024-2025', year: 'All', images: ['https://placehold.co/800x600.png'], links: [{title: 'Sign-up Form', url: '#'}] },
    { id: '5', title: 'Career Fair Prep', date: 'October 28, 2024', description: 'Get your resume ready and practice your interview skills with career services. We will have professional advisors available to review your resume.', type: 'Workshop', academicYear: '2024-2025', year: 'Senior', images: ['https://placehold.co/800x600.png'] },
    { id: '6', title: 'Guest Lecture: The Future of Space Exploration', date: 'November 5, 2024', description: 'A talk by a former NASA astronaut about the next frontier in space travel and research, including upcoming missions to Mars and beyond.', type: 'Seminar', academicYear: '2023-2024', year: 'All', images: ['https://placehold.co/800x600.png'] },
    { id: '7', title: 'Freshman Mixer', date: 'October 30, 2024', description: 'A great opportunity for first-year students to connect. There will be icebreakers, free pizza, and giveaways.', type: 'Social', academicYear: '2024-2025', year: 'Freshman', images: ['https://placehold.co/800x600.png'] },
